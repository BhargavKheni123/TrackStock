...
{
    [AuthorizeHelper]
    public class eVMIResetRequestController : eTurnsControllerBase
    {
        ...
        public ActionResult ResetRequestList()
        {
        ...
        public ActionResult GetResetRequestList(JQueryDataTableParamModel param)
        {
            eVMIResetRequestDTO entity = new eVMIResetRequestDTO();
            ...
            EVMIResetRequestDAL ovjDAL = new EVMIResetRequestDAL(SessionHelper.EnterPriseDBName);
            TimeZoneInfo CurrentTimeZone = (SessionHelper.CurrentTimeZone);
            IEnumerable<eVMIResetRequestDTO> DataFromDB = ovjDAL.GetResetRequestRecordsByPaging(param.iDisplayStart, param.iDisplayLength, out TotalRecordCount, param.sSearch, sortColumnName, SessionHelper.RoomID, SessionHelper.CompanyID, Convert.ToString(SessionHelper.RoomDateFormat), CurrentTimeZone);
            ...
            var result = from u in DataFromDB
                         select new
                         {
                             ...
                             IsResetStarted = u.IsResetStarted,
                             IsResetCompleted = u.IsResetCompleted,
                             //IsPostProcessDone = u.IsPostProcessDone,
                             ResetStartTime = FnCommon.ConvertDateByTimeZone(u.ResetStartTime, true, false),
                             ResetCompletionTime = FnCommon.ConvertDateByTimeZone(u.ResetCompletionTime, true, false),
        ...
        public ActionResult GetResetRequestNarrowSearchHTML()
        {
            return PartialView("_ResetRequestNarrowSearch");
        ...
        public JsonResult GetNarrowSearchData(bool IsDeleted, bool IsArchived)
        {
            ...
            NarrowSearchData objNarrowSearchData = objCommonCtrl.GetNarrowSearchDataFromCache("ResetRequestListMaster", SessionHelper.CompanyID, SessionHelper.RoomID, IsArchived, IsDeleted, "", tmpsupplierIds);
