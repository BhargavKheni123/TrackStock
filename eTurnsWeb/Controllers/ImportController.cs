...
namespace eTurnsWeb.Controllers
{
    ...
    public partial class ImportController : eTurnsControllerBase
    {
        ...
        public List<SelectListItem> GetImportModule()
        {
            ...
            obj = new SelectListItem();
            obj.Text = ResImportMasters.BOMItems;
        ...
        public ActionResult ImportMasters(HttpPostedFileBase uploadFile, HttpPostedFileBase uploadZIPFile, FormCollection formCollection)
        {
            Session["importedData"] = null;
                                ...
                                foreach (DataRow item in list)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        //if (AllowInsert == true)
                                        {
                                            ...
                                            {
                                                obj.eLabelKey = Convert.ToString(item[CommonUtility.ImportItemColumn.eLabelKey.ToString()]);
                                            }
                                            if (item.Table.Columns.Contains(CommonUtility.ImportItemColumn.EnrichedProductData.ToString()))
                                            {
                                                obj.EnrichedProductData = Convert.ToString(item[CommonUtility.ImportItemColumn.EnrichedProductData.ToString()]);
                                            }
                                            if (item.Table.Columns.Contains(CommonUtility.ImportItemColumn.EnhancedDescription.ToString()))
                                            {
                                                obj.EnhancedDescription = Convert.ToString(item[CommonUtility.ImportItemColumn.EnhancedDescription.ToString()]);
                                            }
                                ...
                                foreach (DataRow item in list)
                                {
                                    ...
                                    try
                                    {
                                            ...
                                            && !string.IsNullOrWhiteSpace(Convert.ToString(item[CommonUtility.ImportSupplierCatalogColumn.ItemNumber.ToString()])))
                                        {
                                            ...
                                            if (item.Table.Columns.Contains(CommonUtility.ImportSupplierCatalogColumn.UNSPSC.ToString()))
                                            {
                                                obj.UNSPSC = item[CommonUtility.ImportSupplierCatalogColumn.UNSPSC.ToString()].ToString();
                                            }
                                            if (item.Table.Columns.Contains(CommonUtility.ImportSupplierCatalogColumn.LongDescription.ToString()))
                                            {
                                                obj.LongDescription = item[CommonUtility.ImportSupplierCatalogColumn.LongDescription.ToString()].ToString();
                                            }
                                            if (item.Table.Columns.Contains(CommonUtility.ImportSupplierCatalogColumn.Category.ToString()))
                                            {
                                                obj.Category = item[CommonUtility.ImportSupplierCatalogColumn.Category.ToString()].ToString();
                                            }
                                            obj.Id = recordCount++;
                                            lstImport.Add(obj);
                                        }
            ...
            if (!string.IsNullOrEmpty(ModuleName))
            {
                switch (ModuleName)
                {
                    ...
                    case "SupplierCatalog":
                        ...
                        retval = "ItemNumber,Description,SellPrice,ManufacturerPartNumber,ImagePath,UPC,SupplierPartNumber,SupplierName,ManufacturerName,UOM,CostUOM,Cost,UNSPSC,LongDescription,Category";
                        break;
                    case "ReturnOrders":
        ...
        {
            return ImportBAL.GetIDs(TableName, strVal, longID);
            //Int64 returnID = 0;
        ...
        private CustomerMasterDTO GetCustomerMaster(ImportMastersDTO.TableName TableName, string strVal, long longID = 0)
        {
            ...
            if (TableName == ImportMastersDTO.TableName.CustomerMaster)
            {
                ...
                if (strOK == "duplicate")
                {
                    ...
                    obj = objDAL.GetCustomerByName(strVal, SessionHelper.RoomID, SessionHelper.CompanyID);
                    if (obj != null)
                        return obj;
                }
                else
        ...
        private static Int64 GetBOMIDs(ImportMastersDTO.TableName TableName, string strVal)
        {
            ...
            if (TableName == ImportMastersDTO.TableName.ManufacturerMaster)
            {
                ...
                {
                    ManufacturerMasterDTO obj = null;
                    obj = objDAL.GetManufacturerByNameNormal(strVal.ToLower(), SessionHelper.RoomID, SessionHelper.CompanyID, true);
                    if (obj != null)
                        returnID = obj.ID;
                }
                else
            ...
            else if (TableName == ImportMastersDTO.TableName.SupplierMaster)
            {
                ...
                {
                    SupplierMasterDTO obj = null;
                    obj = objDAL.GetSupplierByNamePlain(SessionHelper.RoomID, SessionHelper.CompanyID, true, strVal);
                    if (obj != null)
                        returnID = obj.ID;
                }
                else
            ...
            else if (TableName == ImportMastersDTO.TableName.UnitMaster)
            {
                ...
                {
                    UnitMasterDTO obj = null;
                    obj = objDAL.GetUnitByNamePlain(SessionHelper.RoomID, SessionHelper.CompanyID, true, strVal);
                    if (obj != null && obj.ID > 0)
                        returnID = obj.ID;
                }
                else
            ...
            else if (TableName == ImportMastersDTO.TableName.InventoryClassificationMaster)
            {
                ...
                {
                    InventoryClassificationMasterDTO obj = null;
                    obj = objInventoryClassificationMasterDAL.GetInventoryClassificationByNamePlain(SessionHelper.RoomID, SessionHelper.CompanyID, true, strVal);
                    if (obj != null)
                        returnID = obj.ID;
                }
                else
        ...
        {
            return ImportBAL.GetGUID(TableName, strVal, optValue, QLType);
        ...
        private static void CheckUDF(List<UDFOptionsCheckDTO> lst, List<UDFOptionsMain> CurrentOptionList, string objDTOUDF, string UDFs)
        {
            ...
            ImportBAL.CheckUDF(lst, CurrentOptionList, objDTOUDF, UDFs);
        ...
        public DataTable GetToolCountTableFromList(List<ToolAssetQuantityDetailDTO> lstItemLocs)
        {
            RegionSettingDAL objRegionSettingDAL = new RegionSettingDAL(SessionHelper.EnterPriseDBName);
            DateTime datetimetoConsider = objRegionSettingDAL.GetCurrentDatetimebyTimeZone(SessionHelper.RoomID, SessionHelper.CompanyID, SessionHelper.UserID);
            DataTable ReturnDT = new DataTable("ToolAssetLocationParam");
