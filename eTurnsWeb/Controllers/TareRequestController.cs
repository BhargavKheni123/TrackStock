...
{
    public class TareRequestController : eTurnsControllerBase
    {
        ...
        public ActionResult GetItemLocationTareList(JQueryDataTableParamModel param)
        {
           ...
           // bool IsDeleted = bool.Parse(Request["IsDeleted"].ToString());
            ...
            ItemLocationTareRequestDAL objDAL = new ItemLocationTareRequestDAL(SessionHelper.EnterPriseDBName);
            TimeZoneInfo CurrentTimeZone = (SessionHelper.CurrentTimeZone);
            List<ItemLocationTareRequestDTO> DataFromDB = objDAL.GetTareRequestListByPaging(param.iDisplayStart, param.iDisplayLength, out TotalRecordCount, param.sSearch, sortColumnName, SessionHelper.RoomID, SessionHelper.CompanyID,  Convert.ToString(SessionHelper.RoomDateFormat), CurrentTimeZone);
        ...
        public ActionResult GetTareNarrwSearchHTML()
        {
            return PartialView("_TareNarrowSearch");
        ...
        {           
            ...
            ItemLocationTareRequestDAL ILPRDAL = new ItemLocationTareRequestDAL(SessionHelper.EnterPriseDBName);
            
            TareNarrowSearchData objNarrowSearch = ILPRDAL.GetItemLocationTareListNarrowSearchData(SessionHelper.CompanyID, SessionHelper.RoomID);
