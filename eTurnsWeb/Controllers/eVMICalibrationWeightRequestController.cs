...
{
    public class eVMICalibrationWeightRequestController : eTurnsControllerBase
    {
        ...
        public ActionResult eVMICalibrationWeightList()
        {
        ...
        public ActionResult GeteVMICalibrationWeightList(JQueryDataTableParamModel param)
        {
            eVMICalibrationWeightRequestDTO objDTO = new eVMICalibrationWeightRequestDTO();
            ...
            eVMICalibrationWeightRequestDAL ovjDAL = new eVMICalibrationWeightRequestDAL(SessionHelper.EnterPriseDBName);
            TimeZoneInfo CurrentTimeZone = (SessionHelper.CurrentTimeZone);
            IEnumerable<eVMICalibrationWeightRequestDTO> DataFromDB = ovjDAL.GeteVMICalibrationWeightRequestRecordsByPaging(param.iDisplayStart, param.iDisplayLength, out TotalRecordCount, param.sSearch, sortColumnName, SessionHelper.RoomID, SessionHelper.CompanyID, Convert.ToString(SessionHelper.RoomDateFormat), CurrentTimeZone);
            ...
            var result = from u in DataFromDB
                         select new
                         {
                             ...
                             CalibrationWeight = u.CalibrationWeight,
                             ComPortName = u.ComPortName,
                             IsCalWeightStarted = u.IsCalWeightStarted,
                             IsCalWeightCompleted = u.IsCalWeightCompleted,
                             //IsPostProcessDone = u.IsPostProcessDone,
                             CalWeightStartTime = FnCommon.ConvertDateByTimeZone(u.CalWeightStartTime, true, false),
                             CalWeightCompletionTime = FnCommon.ConvertDateByTimeZone(u.CalWeightCompletionTime, true, false),
        ...
        public ActionResult GeteVMICalibrationWeightNarrowSearchHTML()
        {
            return PartialView("_eVMICalibrationWeightNarrowSearch");
        ...
        public JsonResult GetNarrowSearchData(bool IsDeleted, bool IsArchived)
        {
            ...
            NarrowSearchData objNarrowSearchData = objCommonCtrl.GetNarrowSearchDataFromCache("eVMICalibrationWeightListMaster", SessionHelper.CompanyID, SessionHelper.RoomID, IsArchived, IsDeleted, "", tmpsupplierIds);
