...
namespace eTurnsWeb.Controllers.WebAPI
{
    public class LocationMasterController : ApiController
    {
        ...
        /// </summary>
        LocationMasterDAL _repository = new LocationMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IEnumerable<LocationMasterDTO> GetAllRecord(Int64 RoomID, Int64 CompanyId)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(LocationMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, LocationMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        /// <returns></returns>
        [HttpGet]
        public IEnumerable<LocationMasterDTO> GetPagedRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortOrder, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        public string DuplicateCheck(string Name, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            ...
            return objCDal.DuplicateCheck(Name, ActionMode, ID, "LocationMaster", "Location",RoomID,EnterpriseID);
        }
