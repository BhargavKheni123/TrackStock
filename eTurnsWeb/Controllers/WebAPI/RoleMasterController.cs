...
namespace eTurnsWeb.Controllers.WebAPI
{
    public class RoleMasterController : ApiController
    {
        ...
        public RoleMasterDAL _repository = new RoleMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IEnumerable<RoleMasterDTO> GetAllRecord(Int64 roomID, Int64 EnterpriseID)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IEnumerable<RoleModuleDetailsDTO> GetRoleModuleDetailsRecord(Int64 id, Int64 RoomID)
        {
            return _repository.GetRoleModuleDetailsRecord(id, RoomID);
        }
        ...
        // GET api/Role
        [HttpGet]
        public IEnumerable<RoleMasterDTO> GetAllRecords(Int64 CompanyID, int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID)
        {
        ...
        [HttpGet]
        public string DuplicateCheck(string RoleName, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(RoleName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(RoleName, ActionMode, ID, "RoleMaster", "RoleName",RoomID,EnterpriseID);
        }
