...
namespace eTurnsWeb.Controllers.WebAPI.EturnsMaster
{
    public class ModuleMasterController : ApiController
    {
        ...
        public eTurnsMaster.DAL.ModuleMasterDAL _repository = new eTurnsMaster.DAL.ModuleMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IEnumerable<ModuleMasterDTO> GetAllRecord(Int32 EnterpriseID)
        {
        ...
        {
            return _repository.GetModuleNotification(ModuleId, UserId);
        }
