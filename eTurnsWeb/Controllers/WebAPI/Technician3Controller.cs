...
using eTurns.DTO;
using eTurns.DAL.Repository;
using eTurns.DAL.Abstract;

namespace eTurnsWeb.Controllers.WebAPI
{
    public class Technician3Controller : ApiController
    {

        static readonly ITechnicianMaster _repository = new TechnicialMaster3Repository();
