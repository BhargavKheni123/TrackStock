...
namespace eTurnsWeb.Controllers.WebAPI
{
    ...
    {
        public RoomDAL _repository = new RoomDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IEnumerable<RoomDTO> GetAllRecords(Int64 CompanyId)
        {
            return _repository.GetAllRecords(CompanyId, false, false);
        }
        ...
        {
            return _repository.GetRecord(id, CompanyID, IsArchived, IsDeleted);
        }
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(RoomDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, RoomDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/technician
        [HttpGet]
        public IEnumerable<RoomDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
            return _repository.GetPagedRecords(StartRowIndex, MaxRows, out TotalCount, SearchTerm, sortColumnName, CompanyId, IsArchived, IsDeleted);
        }
        ...
        [HttpGet]
        public string DuplicateCheck(string TechnicianName, string ActionMode, string FieldName, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(TechnicianName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(TechnicianName, ActionMode, ID, "Room", FieldName, RoomID, EnterpriseID);
        }
