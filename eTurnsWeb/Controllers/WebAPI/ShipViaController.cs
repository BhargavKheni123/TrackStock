...
namespace eTurnsWeb.Controllers.WebAPI
{
    ...
    {
        public ShipViaDAL _repository = new ShipViaDAL();


        // GET api/technician
        public IQueryable<ShipViaDTO> GetAllRecords(Int64 RoomID, Int64 CompanyId)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(ShipViaDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, ShipViaDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/technician
        [HttpGet]
        public IEnumerable<ShipViaDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        [HttpGet]
        public string DuplicateCheck(string ShipViaName, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(ShipViaName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(ShipViaName, ActionMode, ID, "ShipViaMaster", "ShipVia", RoomID,EnterpriseID);
        }
