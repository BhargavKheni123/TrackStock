...
namespace eTurnsWeb.Controllers.WebAPI
{
    ...
    {
        public UnitMasterDAL _repository = new UnitMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public UnitMasterDTO GetRecord(Int64 id, Int64 RoomID, Int64 CompanyID, bool IsArchived, bool IsDeleted)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(UnitMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, UnitMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/technician
        [HttpGet]
        public IEnumerable<UnitMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        [HttpGet]
        public string DuplicateCheck(string UnitName, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(UnitName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(UnitName, ActionMode, ID, "UnitMaster", "Unit", RoomID,EnterpriseID);
        }
