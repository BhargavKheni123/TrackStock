...
{
    public class MeasurementTermController : ApiController
    {
        public MeasurementTermDAL _repository = new MeasurementTermDAL();
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(MeasurementTermMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, MeasurementTermMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/technician
        [HttpGet]
        public IEnumerable<MeasurementTermMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        public string DuplicateCheck(string Name, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            ...
            return objCDal.DuplicateCheck(Name, ActionMode, ID, "MeasurementTermMaster", "MeasurementTerm", RoomID,EnterpriseID);
        }
