...
{
    public class GXPRConsignedJobController : ApiController
    {
        public GXPRConsignedJobMasterDAL _repository = new GXPRConsignedJobMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IEnumerable<GXPRConsigmentJobMasterDTO> GetAllRecord(Int64 RoomID, Int64 CompanyId)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(GXPRConsigmentJobMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, GXPRConsigmentJobMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/technician
        [HttpGet]
        public IEnumerable<GXPRConsigmentJobMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        [HttpGet]
        public string DuplicateCheck(string GXPRConsigmentJob, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(GXPRConsigmentJob, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(GXPRConsigmentJob, ActionMode, ID, "GXPRConsigmentJobMaster", "GXPRConsigmentJob",RoomID,EnterpriseID);
        }
