...
{
    public class ToolMasterController : ApiController
    {
        public ToolMasterDAL _repository = new ToolMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ToolMasterDTO GetRecord(Int64 id, Int64 RoomID, Int64 CompanyID, bool IsArchived, bool IsDeleted)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(ToolMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, ToolMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/tool
        [HttpGet]
        public IEnumerable<ToolMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        [HttpGet]
        public string DuplicateCheck(string ToolName, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(ToolName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(ToolName, ActionMode, ID, "ToolMaster", "ToolName",RoomID,EnterpriseID);
        }
