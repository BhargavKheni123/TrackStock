...
{
    public class ToolCategoryMasterController : ApiController
    {
        public ToolCategoryMasterDAL _repository = new ToolCategoryMasterDAL();
        ...
        {
            return _repository.GetAllRecords(RoomID, CompanyId,IsDeleted,IsArchived);
        }
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(ToolCategoryMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, ToolCategoryMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/ToolCategory
        [HttpGet]
        public IEnumerable<ToolCategoryMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        [HttpGet]
        public string DuplicateCheck(string ToolCategoryName, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(ToolCategoryName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(ToolCategoryName, ActionMode, ID, "ToolCategoryMaster", "ToolCategory", RoomID,EnterpriseID);
        }
