...
namespace eTurnsWeb.Controllers.WebAPI
{
    ...
    {
        private SupplierMasterDAL _repository = new SupplierMasterDAL();

        /// <summary>
        /// GetRecords
        /// </summary>
        /// <returns></returns>
        public IQueryable<SupplierMasterDTO> GetRecords(Int64 RoomID, Int64 CompanyID)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public SupplierMasterDTO GetRecord(Int64 id, Int64 RoomID, Int64 CompanyID, bool IsArchived, bool IsDeleted)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(SupplierMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, SupplierMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        /// <returns></returns>
        [HttpGet]
        public string DuplicateCheck(string SupplierName, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(SupplierName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(SupplierName, ActionMode, ID, "SupplierMaster", "SupplierName",RoomID,EnterpriseID);
        }
        ...
        /// <returns></returns>
        [HttpGet]
        public IEnumerable<SupplierMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
