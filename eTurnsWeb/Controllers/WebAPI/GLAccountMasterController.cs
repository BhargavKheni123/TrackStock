...
{
    public class GLAccountMasterController : ApiController
    {
        public GLAccountMasterDAL _repository = new GLAccountMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public GLAccountMasterDTO GetRecord(Int64 id, Int64 RoomID, Int64 CompanyID, bool IsArchived, bool IsDeleted)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(GLAccountMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, GLAccountMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        // GET api/technician
        [HttpGet]
        public IEnumerable<GLAccountMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        public string DuplicateCheck(string name, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            ...
            return objCDal.DuplicateCheck(name, ActionMode, ID, "GLAccountMaster", "GLAccount",RoomID,EnterpriseID);
        }
