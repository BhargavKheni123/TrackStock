...
{
    public class TransferMasterController : ApiController
    {
        ...
        /// <returns></returns>
        public TransferMasterDTO GetRecordByRefTransferID(Int64 id, Int64 RoomID, Int64 CompanyID)
        {
            return _repository.GetRecordByRefTransferID(id, RoomID, CompanyID);
        }

        public TransferMasterDTO GetHistoryRecord(Int64 id)
        {
        ...
        // GET api/Transfer
        [HttpGet]
        public IEnumerable<TransferMasterDTO> GetPagedRecords(Int32 StartRowIndex, Int32 MaxRows, out Int32 TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyID, bool IsArchived, bool IsDeleted)
        {
