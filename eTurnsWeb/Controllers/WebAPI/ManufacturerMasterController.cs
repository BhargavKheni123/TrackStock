...
{
    public class ManufacturerMasterController : ApiController
    {       
        public ManufacturerMasterDAL _repository = new ManufacturerMasterDAL();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ManufacturerMasterDTO GetRecord(Int64 id, Int64 RoomID, Int64 CompanyID, bool IsArchived, bool IsDeleted)
        {
        ...
        /// <returns></returns>
        public HttpResponseMessage PostRecord(ManufacturerMasterDTO objDTO)
        {
        ...
        /// <param name="objDTO"></param>
        /// <returns></returns>
        public HttpResponseMessage PutRecord(Int64 id, ManufacturerMasterDTO objDTO)
        {
            HttpStatusCode hStatusCode = HttpStatusCode.OK;
        ...
        [HttpGet]
        public IEnumerable<ManufacturerMasterDTO> GetAllRecords(int StartRowIndex, int MaxRows, out int TotalCount, string SearchTerm, string sortColumnName, Int64 RoomID, Int64 CompanyId, bool IsArchived, bool IsDeleted)
        {
        ...
        [HttpGet]
        public string DuplicateCheck(string ManufacturerName, string ActionMode, Int64 ID, Int64 RoomID, Int64 EnterpriseID)
        {
            //return _repository.DuplicateCheck(ManufacturerName, ActionMode, ID);
            CommonDAL objCDal = new CommonDAL();
            return objCDal.DuplicateCheck(ManufacturerName, ActionMode, ID, "ManufacturerMaster", "Manufacturer",RoomID,EnterpriseID);
        }
