    ...
    ColReorder.prototype = {
        ...
        */
        "_fnMouseDown": function (e, nTh, i) {
            ...
            $(document).bind('mousedown.ColReorder', function (e) {
                isDragging = false;
                console.log('mousedown.ColReorder : ' + isDragging);
            });
            ...
            $(document).bind('mousemove.ColReorder', function (e) {
                ...
                isDragging = true;
                console.log('mousemove.ColReorder : ' + isDragging);
            });

            $(document).bind('mouseup.ColReorder', function (e) {
                console.log('mouseup.ColReorder : ' + isDragging);
                if (isDragging) {
                    isDragging = false;
        ...
        */
        "_fnMouseUp": function (e, colResized) {
            ...
            $(document).unbind('mousedown.ColReorder');
