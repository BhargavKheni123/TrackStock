...
function RoomChanged() {
    ...
    var SelecteUserID = GetUserID();
    $("#CreateRolePermissionDIV").load("/Master/UserRolePermissionCreate",
...
//            $("#RoomData").multiselect("refresh");
        ...
        Rn = $("#hdnSelectedEnterpriseAccessValue").val().split(",");
...
//            $("#EnterpriseData").multiselect("refresh");
//        }
        Rn = $("#hdnSelectedCompanyAccessValue").val().split(",");
//        for (var i = 0; i < Rn.length; i++) {
//            var Rnames = Rn[i].split("_");
...
//        }
        ...
        Rn = $("#hdnSelectedRoomReplanishmentValue").val().split(",");
//        for (var i = 0; i < Rn.length; i++) {
//            var Rnames = Rn[i].split("_");
...
//        }
        if (FirstRoomID != "") {
            ...
            $("#CreateRolePermissionDIV").load("/Master/UserRolePermissionCreate", {
                RoomID: FirstRoomID, RoleID: SelectedRoleID, UserID: SelecteUserID, UserType: $("#drpUserType").val()
            }, function () {
