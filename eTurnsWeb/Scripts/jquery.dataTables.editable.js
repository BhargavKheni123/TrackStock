...
(function ($) {
    ...
    function fnApplyEditable(aoNodes) {
        var oDefaultEditableSettings = {
            ...
            "submitdata": function (value, settings) {
                ...
                // above code commented and added below line By Niraj to get column name
                var sColumnName = oTable.fnSettings().aoColumns[columnId].mDataProp;
    ...
    $.fn.makeEditable = function (options) {
        ...
        return this.each(function () {
                ...
                oTable.fnSettings().aoDrawCallback.push({
                    "fn": function () {
                        ...
                        $(oTable.fnGetNodes()).each(function () {
                            ...
                            // commented above line and added below line by Niraj
                            var id = oTable.fnGetData(position).ID;
            ...
            // below method commented for muliple selection of rows for delete by Niraj   
