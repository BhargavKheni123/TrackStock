    ...
    TableTools.prototype = {
        ...
        */
        "_fnPrintStart": function (oConfig) {
            ...
            /*START - Remove the link in preview */
            $('#' + this.s.dt.sTableId + '').find('input,select').each(function(){               
                    $(this).attr("disabled", "disabled");                    
            });
            $('#' + this.s.dt.sTableId + '').find('a').each(function(){               
                    $(this).removeAttr("onclick", "");                    
            });
            /*END - Remove the link in preview */                
