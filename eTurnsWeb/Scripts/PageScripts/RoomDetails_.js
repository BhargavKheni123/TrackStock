...
function Validations() {
    ...
    if ((IsTax1Parts == true || IsTax1Labor == true) && txtTax1name.val() == '') {
        ...
        //$("div#target").delay(2000).fadeOut(200);
        showNotificationDialog();
        $("#spanGlobalMessage").text('Tax1 name is required');
        $("#spanGlobalMessage").removeClass('succesIcon WarningIcon').addClass('errorIcon');
        $('#txtTax1name').focus();
        return false;
    }
    if ((IsTax1Parts == true || IsTax1Labor == true) && txtTax1Rate.val() == '') {
        ...
        //$("div#target").delay(2000).fadeOut(200);
        showNotificationDialog();
        $("#spanGlobalMessage").text('Tax1 percent is required');
        $("#spanGlobalMessage").removeClass('succesIcon WarningIcon').addClass('errorIcon');
        $('#txtTax1Rate').focus();
        return false;
    }
    ...
    if ((IsTax2Parts == true || IsTax2Labor == true) && txtTax2name.val() == '') {
        ...
        //$("div#target").delay(2000).fadeOut(200);
        showNotificationDialog();
        $("#spanGlobalMessage").text('Tax2 name is required');
        $("#spanGlobalMessage").removeClass('succesIcon WarningIcon').addClass('errorIcon');
        $('#txtTax2name').focus();
        return false;
    }
    if ((IsTax2Parts == true || IsTax2Labor == true) && txtTax2Rate.val() == '') {
        ...
        //$("div#target").delay(2000).fadeOut(200);
        showNotificationDialog();
        $("#spanGlobalMessage").text('Tax2 percent is required');
        $("#spanGlobalMessage").removeClass('succesIcon WarningIcon').addClass('errorIcon');
        $('#txtTax2Rate').focus();
        return false;
    }
