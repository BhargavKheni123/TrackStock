    ...
    public class AlertMail
    {
        ...
        public List<eMailAttachmentDTO> GenerateBytesBasedOnAttachmentForAlert(NotificationDTO objNotificationDTO, EnterpriseDTO objEnterprise, Dictionary<string, string> Params)
        {
            ...
            try
            {
                if (objNotificationDTO != null)
                {
                    ...
                    if (objNotificationDTO.AttachedReportMasterDTO != null && !string.IsNullOrEmpty(strEmail))
                    {
                        ...
                        if (!rptPara.Keys.Contains("ReportFields"))
                        {
                            try
                            {
                                ...
                                if (lstSortingRows.Count > 1)
                                {
                                    ...
                                    foreach (string cl in lstReportFields)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(cl))
                                        {
                                            ...
                                            while (str != string.Empty)
                                            {
                                                ...
                                                int posP1 = str.IndexOf("Parameters!") + "Parameters!".Length;
                                    ...
                                    rptPara.Add("ReportFields", strlstReportFieldsList);
                                }
                            }
                            catch (Exception ex)
                            {
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            if (objNotificationDTO.AttachmentTypes == "1")
                            {
                                ...
                                //string filePath = ReportBasePath + @"\Temp\" + Reportname + "_Resource.pdf";
                                //System.IO.File.WriteAllBytes(filePath, tempByte);
            ...
            catch (Exception ex)
            {
                ...
                objReportSchedulerError.EnterpriseID = objEnterprise.ID;
                objReportSchedulerError.RoomID = objNotificationDTO.RoomID;
                objReportSchedulerError.UserID = objNotificationDTO.CreatedBy;
        ...
        public List<eMailAttachmentDTO> GenerateBytesBasedOnAttachmentForAlertQuoteandOrder(NotificationDTO objNotificationDTO, EnterpriseDTO objEnterprise, Dictionary<string, string> Params)
        {
            List<eMailAttachmentDTO> bytes = new List<eMailAttachmentDTO>();
            ...
            try
            {
                if (objNotificationDTO != null)
                {
                    objDAL = new ReportMasterDAL(objEnterprise.EnterpriseDBName);
                    rsDAL = new RegionSettingDAL(objEnterprise.EnterpriseDBName);
                    rsInfo = rsDAL.GetRegionSettingsById(SessionHelper.RoomID, SessionHelper.CompanyID, 0);
                    amDAL = new eTurns.DAL.AlertMail();
                    ...
                    if (objNotificationDTO.AttachedReportMasterDTO != null && !string.IsNullOrEmpty(strEmail))
                    {
                        ...
                        if (objNotificationDTO.AttachedReportMasterDTO.ParentID > 0)
                        {
                            ...
                            {
                                ReportPath = CopyFiletoTempForAlert(ReportBasePath + @"\" + objEnterprise.ID + @"\" + SessionHelper.CompanyID + @"\" + MasterReportname, mainGuid, ReportBasePath + @"\Temp");
                            }
                        }
                        else
                        {
                        ...
                        //lstUpdateTablix = UpdateResourceForAlert(lstTablix, MasterReportResFile);
                        lstUpdateTablix = UpdateResourceForAlertNew(lstTablix, MasterReportResFile, strCulture, objEnterprise.ID, SessionHelper.CompanyID, SessionHelper.RoomID);
                        doc.Save(ReportPath);
                        //doc = XDocument.Load(ReportPath);
                        ...
                        rptPara = SetGetPDFReportParaDictionary(objEnterprise, SessionHelper.CompanyID, SessionHelper.RoomID, objNotificationDTO, Params);
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            if (doc.Descendants(ns + "Subreport") != null && doc.Descendants(ns + "Subreport").Count() > 0)
                            {
                                ...
                                if (objNotificationDTO.AttachedReportMasterDTO.ParentID > 0)
                                {
                                    ...
                                    {
                                        rdlPath = CopyFiletoTempForAlert(ReportBasePath + @"\" + objEnterprise.ID + @"\" + SessionHelper.CompanyID + @"\" + SubReportname, subGuid, ReportBasePath + @"\Temp");
                                    }
                                }
                                else
                                {
                                ...
                                //lstUpdateSubTablix = UpdateResourceForAlert(lstSubTablix, SubReportResFile);
                                lstUpdateSubTablix = UpdateResourceForAlertNew(lstSubTablix, SubReportResFile, strCulture, objEnterprise.ID, SessionHelper.CompanyID, SessionHelper.RoomID);
                                docSub.Save(rdlPath);
                                docSub = XDocument.Load(rdlPath);
            ...
            catch (Exception ex)
            {
                ...
                objReportSchedulerError.CompanyID = SessionHelper.CompanyID;
                objReportSchedulerError.EnterpriseID = objEnterprise.ID;
                objReportSchedulerError.RoomID = SessionHelper.RoomID;
                objReportSchedulerError.UserID = objNotificationDTO.CreatedBy;
                objReportSchedulerError.Exception = Convert.ToString(ex) ?? "Null exception";
        ...
        private Dictionary<string, string> SetGetPDFReportParaDictionary(EnterpriseDTO EntDTO, long CompanyID, long RoomID, NotificationDTO objNotificationDTO, Dictionary<string, string> Params)
        {
            ...
            try
            {
                ...
                dictionary.Add("WOSignatureURL", System.Configuration.ConfigurationManager.AppSettings["LocalHostName"] + "/Uploads/WorkOrderSignature/" + CompanyID + "/");
                dictionary.Add("WOAttachmentPath", System.Configuration.ConfigurationManager.AppSettings["LocalHostName"] + "/Uploads/WorkOrderFile/" + EntDTO.ID + "/" + CompanyID + "/" + RoomID + "/");
                ...
                //dictionary.Add("IsFromAlert", null);

                if (!string.IsNullOrEmpty(objNotificationDTO.SupplierIds) &&
                    objNotificationDTO.EmailTemplateID != (int)MailTemplate.OrderUnSubmitted &&
                    objNotificationDTO.EmailTemplateID != (int)MailTemplate.OrderToSupplier)
        ...
        public void CreateAlertMail(List<eMailAttachmentDTO> objeMailAttchList, string MailSubject, string MessageBody, string ToEmailAddress, NotificationDTO objNotificationDTO, EnterpriseDTO objEnterpriseDTO)
        {
            eTurns.DAL.eMailMasterDAL objUtils = null;
            ...
            {
                string strCCAddress = "";
                objUtils = new eTurns.DAL.eMailMasterDAL(SessionHelper.EnterPriseDBName);
                if (objNotificationDTO != null)
                {
                    ...
                    //if (MailSubject != null && MailSubject.ToLower().Contains("@@date@@"))
                    //{
                    //    string CurrentDate = TZDateTimeNow.ToString(DateTimeFormat);
                    //    MailSubject = MailSubject.Replace("@@DATE@@", CurrentDate).Replace("@@date@@", CurrentDate).Replace("@@Date@@", CurrentDate);
                    //}
                    if (MailSubject != null)
                    {
                        string CurrentDate = TZDateTimeNow.ToString(DateTimeFormat);
                ...
                objUtils.eMailToSend(ToEmailAddress, strCCAddress, MailSubject, MessageBody, objEnterpriseDTO.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, 0, objeMailAttchList);
                ...
                if (objNotificationDTO.AttachedReportMasterDTO != null)
                    objReportMailLogDTO.ReportID = objNotificationDTO.AttachedReportMasterDTO.ID;
                else
                    objReportMailLogDTO.ReportID = 0;
        ...
        public string GetEmailToAddress(string EmailTemplate, string DataBaseName, long RoomId, long CompanyId)
        {
            EmailUserConfigurationDAL objExternalUser = null;
            List<EmailUserConfigurationDTO> arrUsers = null;
            string strToAddress = OverrideToEmail;
            Array ArrToAddress = null;
            try
            {
                string emails = string.Empty;
                objExternalUser = new EmailUserConfigurationDAL(DataBaseName);
                arrUsers = objExternalUser.GetAllEmailUserMaster(EmailTemplate, true, RoomId, CompanyId).ToList();
                if (!string.IsNullOrEmpty(strToAddress))
                {
                    ArrToAddress = strToAddress.Split(',');
                ...
                else
                {
                    ...
                    if (arrUsers != null && arrUsers.Count > 0)
                    {
                        foreach (var item in arrUsers)
                        {
                            ...
                            strToAddress += @"""" + item.Name + @"""" + @"<" + item.Email + @">";
                        }
                    }
        ...
        private string SendMailForPendingOrders(NotificationDTO objNotificationDTO, EnterpriseDTO objEnterprise)
        {
            ...
            try
            {
                ...
                objRoomModuleSettingsDTO = objRoomDAL.GetRoomModuleSettings(objNotificationDTO.CompanyID, objNotificationDTO.RoomID, (long)SessionHelper.ModuleList.Orders);
                ...
                string OrderCostTitle = "OrderCostMail";
                OrderCostTitle = (PriseSelectionOption == 1 ? "OrderPrice" : "OrderCostMail");
                ...
                string strResourceFile = "ResOrder";
                string transferResourceFilePath = GetResourceFileFullPath("ResTransfer", strCulture, objEnterprise.ID, objNotificationDTO.CompanyID);
                string transferResourceFile = "ResTransfer";
                            ...
                            <thead>
                                <tr role=""row"">
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("OrderNumber", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 5%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("ReleaseNumber", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 15%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("Supplier", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("equiredDate", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("OrderStatus", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 5%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("NoOfItems", transferResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, transferResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 5%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath(OrderCostTitle, ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                if (objPendingOrders != null && objPendingOrders.Count() > 0)
                {
                    if (objPendingOrders != null)
                    {
                        ...
                        <td>
                            " + ResourceRead.GetResourceValueByKeyAndFullFilePath(((eTurns.DTO.OrderStatus)item.OrderStatus).ToString(), ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                        </td>
                        <td>
                ...
                if (objPendingOrders != null && objPendingOrders.Count() <= 0)
                {
                    string commonResourceFilePath = GetResourceFileFullPath("ResCommon", strCulture, objEnterprise.ID, objNotificationDTO.CompanyID);
                    string commonResourceFile = "ResCommon";
                    string Str = ResourceRead.GetResourceValueByKeyAndFullFilePath("msgNoDataFound", commonResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, commonResourceFile, strCulture);
                    string RowStyle = string.Empty;
                    trs += @"<tr " + RowStyle + @" >
                        <td colspan=7>
                            " + Str + @"
        ...
        private string SendMailForPendingTransfer(NotificationDTO objNotificationDTO, EnterpriseDTO objEnterprise)
        {
            ...
            try
            {
                ...
                string strResourceFile = "ResTransfer";
                ...
                htmlTabl = @"<table style=""margin-left: 0px; width: 99%;""  border=""1"" cellpadding=""0""
                            ...
                            <thead>
                                <tr role=""row"">
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("TransferNumber", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 15%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("ReplinishRoom", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("RequestType", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("RequireDate", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("TransferStatus", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        private string SendMailForPendingRequisition(NotificationDTO objNotificationDTO, EnterpriseDTO objEnterprise)
        {
            ...
            try
            {
                ...
                string CostTitle = "TotalCost";
                CostTitle = (PriseSelectionOption == 1 ? "TotalPrice" : "TotalCost"); 
                ...
                string strResourceFile = "ResRequisitionMaster";
                string transferResourceFilePath = GetResourceFileFullPath("ResTransfer", strCulture, objEnterprise.ID, objNotificationDTO.CompanyID);
                string transferResourceFile = "ResTransfer";
                string htmlTabl = string.Empty;
                htmlTabl = @"<table style=""margin-left: 0px; width: 99%;""  border=""1"" cellpadding=""0""
                            ...
                            <thead>
                                <tr role=""row"">
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("RequisitionNumber", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 5%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("RequisitionType", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 15%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("WorkorderName", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("RequiredDate", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("RequisitionStatus", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 5%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("NoOfItems", transferResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, transferResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 5%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath(CostTitle, ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        private string SendMailForSuggestedOrder(NotificationDTO objNotificationDTO, EnterpriseDTO objEnterprise)
        {
            ...
            try
            {
                ...
                string strResourceFile = "ResItemMaster";
                ...
                htmlTabl = @"<table style=""margin-left: 0px; width: 99%;""  border=""1"" cellpadding=""0""
                            ...
                            <thead>
                                <tr role=""row"">
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("ItemNumber", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 5%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("SupplierName", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 15%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("BinName", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                    <th  style=""width: 10%; text-align: left;"">
                                        " + ResourceRead.GetResourceValueByKeyAndFullFilePath("Quantity", ResourceFilePath, objEnterprise.ID, objNotificationDTO.CompanyID, objNotificationDTO.RoomID, strResourceFile, strCulture) + @"
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                lstSuggestedOrder = objCartItemDAL.GetPagedRecordsCartListFromDB(0, 100000, out TotalRecordCount, "", "ItemNumber asc", objNotificationDTO.RoomID, objNotificationDTO.CompanyID, false, false, "", tmpsupplierIds, true, "Purchase", SessionHelper.RoomDateFormat, SessionHelper.CurrentTimeZone);
