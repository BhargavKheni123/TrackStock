...
namespace eTurns.DTO
{
    public class JobTypeMasterDTO
    {
        ...
        [Display(Name = "JobType", ResourceType = typeof(ResJobType))]
        ...
        [Display(Name = "UDF1", ResourceType = typeof(ResJobType))]
        public string UDF1 { get; set; }

        [Display(Name = "UDF2", ResourceType = typeof(ResJobType))]
        public string UDF2 { get; set; }

        [Display(Name = "UDF3", ResourceType = typeof(ResJobType))]
        public string UDF3 { get; set; }

        [Display(Name = "UDF4", ResourceType = typeof(ResJobType))]
        public string UDF4 { get; set; }

        [Display(Name = "UDF5", ResourceType = typeof(ResJobType))]
        public string UDF5 { get; set; }

        [Display(Name = "UDF6", ResourceType = typeof(ResJobType))]
        public string UDF6 { get; set; }

        [Display(Name = "UDF7", ResourceType = typeof(ResJobType))]
        public string UDF7 { get; set; }

        [Display(Name = "UDF8", ResourceType = typeof(ResJobType))]
        public string UDF8 { get; set; }

        [Display(Name = "UDF9", ResourceType = typeof(ResJobType))]
        public string UDF9 { get; set; }

        [Display(Name = "UDF10", ResourceType = typeof(ResJobType))]
    ...
    public class ResJobType
    {
        private static string resourceFile = "ResJobType";
        ...
        public static string JobTypeExist
        {
            get
            {
                return ResourceRead.GetResourceValue("JobTypeExist", resourceFile);
            }
        }
    }
}
