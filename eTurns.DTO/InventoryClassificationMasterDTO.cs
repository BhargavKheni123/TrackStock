...
{
    public class InventoryClassificationMasterDTO
    {
        //ID
        ...
        [Display(Name = "InventoryClassification", ResourceType = typeof(ResInventoryClassificationMaster))]
        ...
        //BaseOfInventory
        [Display(Name = "BaseOfInventory", ResourceType = typeof(ResInventoryClassificationMaster))]
        [StringLength(50, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        //[Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(ResMessage))]
        ...
        //RangeStart
        [Display(Name = "RangeStart", ResourceType = typeof(ResInventoryClassificationMaster))]
        ...
        //RangeEnd
        [Display(Name = "RangeEnd", ResourceType = typeof(ResInventoryClassificationMaster))]
        [RegularExpression(@"^[0-9\.]*$", ErrorMessageResourceName = "InvalidValue", ErrorMessageResourceType = typeof(ResMessage))]
        //[Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(ResMessage))]
        public Nullable<System.Double> RangeEnd { get; set; }

        //UDF1
        [Display(Name = "UDF1", ResourceType = typeof(ResInventoryClassificationMaster))]
        ...
        //UDF2
        [Display(Name = "UDF2", ResourceType = typeof(ResInventoryClassificationMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF2 { get; set; }

        //UDF3
        [Display(Name = "UDF3", ResourceType = typeof(ResInventoryClassificationMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF3 { get; set; }

        //UDF4
        [Display(Name = "UDF4", ResourceType = typeof(ResInventoryClassificationMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF4 { get; set; }

        //UDF5
        [Display(Name = "UDF5", ResourceType = typeof(ResInventoryClassificationMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
    ...
    public class ResInventoryClassificationMaster
    {
        private static string ResourceFileName = "ResInventoryClassificationMaster";
        ...
        /// <summary>
        ///   Looks up a localized string similar to InventoryClassificationMaster {0} already exist! Try with Another!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to InventoryClassificationMaster.
        /// </summary>
        public static string InventoryClassificationMasterHeader
        {
            get
            {
                return ResourceRead.GetResourceValue("InventoryClassificationMasterHeader", ResourceFileName);
            }
        }
        ...
        ///   Looks up a localized string similar to InventoryClassificationMaster.
        /// </summary>
        public static string InventoryClassificationMaster
        {
            get
            {
                return ResourceRead.GetResourceValue("InventoryClassificationMaster", ResourceFileName);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to BaseOfInventory.
        /// </summary>
        public static string BaseOfInventory
        {
            get
            {
                return ResourceRead.GetResourceValue("BaseOfInventory", ResourceFileName);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to RangeStart.
        /// </summary>
        public static string RangeStart
        {
            get
            {
                return ResourceRead.GetResourceValue("RangeStart", ResourceFileName);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to RangeEnd.
        /// </summary>
        public static string RangeEnd
        {
            get
            {
                return ResourceRead.GetResourceValue("RangeEnd", ResourceFileName);
            }
        }
        ...
        public static string CycleCountFrequency
        {
            get
            {
                return ResourceRead.GetResourceValue("CycleCountFrequency", ResourceFileName);
            }
        }


        public static string NotProperRange
        {
            get
            {
                return ResourceRead.GetResourceValue("NotProperRange", ResourceFileName);
            }
        }
        public static string ReqStartRange
        {
            get
            {
                return ResourceRead.GetResourceValue("ReqStartRange", ResourceFileName);
            }
        }
        public static string EnterProperRange
        {
            get
            {
                return ResourceRead.GetResourceValue("EnterProperRange", ResourceFileName);
            }
        }
        public static string ValidateEndRange
        {
            get
            {
                return ResourceRead.GetResourceValue("ValidateEndRange", ResourceFileName);
            }
        }
        public static string DefinedStartRange
        {
            get
            {
                return ResourceRead.GetResourceValue("DefinedStartRange", ResourceFileName);
            }
        }
        public static string DefinedEndRange
        {
            get
            {
                return ResourceRead.GetResourceValue("DefinedEndRange", ResourceFileName);
            }
        }
    }
}
