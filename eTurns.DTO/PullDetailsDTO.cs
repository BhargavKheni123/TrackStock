...
namespace eTurns.DTO
{
    public class PullDetailsDTO
    {
        ...
        [Display(Name = "ItemPrice", ResourceType = typeof(ResPullDetails))]
        [RegularExpression(@"^[0-9\.]*$", ErrorMessageResourceName = "InvalidValue", ErrorMessageResourceType = typeof(ResMessage))]
        public Nullable<System.Double> ItemPrice { get; set; }
        ...
        public Nullable<Guid> MaterialStagingPullDetailGUID { get; set; }
        ...
        public Nullable<Guid> MaterialStagingdtlGUID { get; set; }
    ...
    public class ResPullDetails
    {
        private static string ResourceFileName = "ResPullDetails";
    ...
    public class PullCreditHistoryDTO
    {
        public System.Int64 ID { get; set; }
        ...
        public System.Guid? CreditGuid { get; set; }
        public System.Guid? CreditDetailGuid { get; set; }
    }

    #endregion New Changes related to Credit History Table

    public class ItemInfoToPullDetails
    {
