...
{
    public class TransferInOutItemDetailDTO
    {
        ...
        public Nullable<DateTime> TransferedDate { get; set; }
        ...
        public Nullable<Guid> TransferInOutQtyDetailGUID { get; set; }
        ...
        public Nullable<double> ProcessedCustomerOwnedQuantity { get; set; }
        public Nullable<double> ProcessedConsignedQuantity { get; set; }
