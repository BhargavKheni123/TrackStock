...
namespace eTurns.DTO
{
    public class VenderMasterDTO
    {
        ...
        //Vender
        [Display(Name = "Vender", ResourceType = typeof(ResVenderMaster))]
        ...
        //UDF1
        [Display(Name = "UDF1", ResourceType = typeof(ResVenderMaster))]
        ...
        //UDF2
        [Display(Name = "UDF2", ResourceType = typeof(ResVenderMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF2 { get; set; }

        //UDF3
        [Display(Name = "UDF3", ResourceType = typeof(ResVenderMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF3 { get; set; }

        //UDF4
        [Display(Name = "UDF4", ResourceType = typeof(ResVenderMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF4 { get; set; }

        //UDF5
        [Display(Name = "UDF5", ResourceType = typeof(ResVenderMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
    ...
    public class ResVenderMaster
    {
        private static string ResourceFileName = "ResVenderMaster";
        ...
        /// <summary>
        ///   Looks up a localized string similar to VenderMaster {0} already exist! Try with Another!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to VenderMaster.
        /// </summary>
        ...
        ///   Looks up a localized string similar to VenderMaster.
        /// </summary>
        public static string VenderMaster
        {
            get
            {
                return ResourceRead.GetResourceValue("VenderMaster", ResourceFileName);
            }
        }
        ...
        public static string Vender
        {
            get
            {
                return ResourceRead.GetResourceValue("Vender", ResourceFileName);
            }
        }
