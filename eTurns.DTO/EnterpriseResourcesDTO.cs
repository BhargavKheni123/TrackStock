...
{
    [Serializable]
    public class EnterpriseResourcesDTO
    {
    ...
    [Serializable]
    public class EnterpriseResourcesKeyValDTO
    {
        public string ResourceKey { get; set; }
        public string ResourceValue { get; set; }
    }

    public class ResEnterpriseResources
    {
        private static string ResourceFileName = "ResEnterpriseResources";
        ...
        public static string QLDetailNumber
        {
            get
            {
                return ResourceRead.GetResourceValue("QLDetailNumber", ResourceFileName);
            }
        }
    }
