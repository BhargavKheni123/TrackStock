...
{
    public class OrderUOMMasterDTO
    {
        //ID
        public System.Int64 ID { get; set; }

        //OrderUOM
        [Display(Name = "OrderUOM", ResourceType = typeof(ResOrderUOMMaster))]
        [StringLength(50, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(ResMessage))]
        public System.String OrderUOM { get; set; }

        //OrderUOMValue
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(ResMessage))]
        [Display(Name = "OrderUOMValue", ResourceType = typeof(ResOrderUOMMaster))]
        public Nullable<System.Int32> OrderUOMValue { get; set; }

        //UDF1
        [Display(Name = "UDF1", ResourceType = typeof(ResOrderUOMMaster))]
        ...
        //UDF2
        [Display(Name = "UDF2", ResourceType = typeof(ResOrderUOMMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF2 { get; set; }

        //UDF3
        [Display(Name = "UDF3", ResourceType = typeof(ResOrderUOMMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF3 { get; set; }

        //UDF4
        [Display(Name = "UDF4", ResourceType = typeof(ResOrderUOMMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
        public System.String UDF4 { get; set; }

        //UDF5
        [Display(Name = "UDF5", ResourceType = typeof(ResOrderUOMMaster))]
        [StringLength(255, ErrorMessageResourceName = "MaxLength", ErrorMessageResourceType = typeof(ResMessage))]
        [AllowHtml]
    ...
    public class ResOrderUOMMaster
    {
        private static string ResourceFileName = "ResOrderUOMMaster";
        ...
        /// <summary>
        ///   Looks up a localized string similar to OrderUOMMaster {0} already exist! Try with Another!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to OrderUOMMaster.
        /// </summary>
        public static string OrderUOMMasterHeader
        {
            get
            {
                return ResourceRead.GetResourceValue("OrderUOMMasterHeader", ResourceFileName);
            }
        }
        ...
        ///   Looks up a localized string similar to OrderUOMMaster.
        /// </summary>
        public static string OrderUOMMaster
        {
            get
            {
                return ResourceRead.GetResourceValue("OrderUOMMaster", ResourceFileName);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to OrderUOM.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to OrderUOMValue.
        /// </summary>
        public static string OrderUOMValue
        {
            get
            {
                return ResourceRead.GetResourceValue("OrderUOMValue", ResourceFileName);
            }
        }
