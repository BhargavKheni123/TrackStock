...
{
    public class FreightTypeMasterDTO
    {
        ...
        [Display(Name = "FreightType", ResourceType = typeof(ResFreightType))]
        ...
        [Display(Name = "UDF1", ResourceType = typeof(ResFreightType))]
        public string UDF1 { get; set; }

        [Display(Name = "UDF2", ResourceType = typeof(ResFreightType))]
        public string UDF2 { get; set; }

        [Display(Name = "UDF3", ResourceType = typeof(ResFreightType))]
        public string UDF3 { get; set; }

        [Display(Name = "UDF4", ResourceType = typeof(ResFreightType))]
        public string UDF4 { get; set; }

        [Display(Name = "UDF5", ResourceType = typeof(ResFreightType))]
        public string UDF5 { get; set; }

        [Display(Name = "UDF6", ResourceType = typeof(ResFreightType))]
        public string UDF6 { get; set; }

        [Display(Name = "UDF7", ResourceType = typeof(ResFreightType))]
        public string UDF7 { get; set; }

        [Display(Name = "UDF8", ResourceType = typeof(ResFreightType))]
        public string UDF8 { get; set; }

        [Display(Name = "UDF9", ResourceType = typeof(ResFreightType))]
        public string UDF9 { get; set; }

        [Display(Name = "UDF10", ResourceType = typeof(ResFreightType))]
    ...
    public class ResFreightType
    {


        private static string resourceFile = "ResFreightType";


        /// <summary>
        ///   Looks up a localized string similar to Freight Type.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to eTurns: Freight Types.
        /// </summary>
