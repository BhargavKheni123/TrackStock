...
{
    public class GXPRConsigmentJobMasterDTO
    {
        ...
        [AllowHtml]
        [Display(Name = "GXPRConsignedJob", ResourceType = typeof(ResGXPRConsignedJob))]
        ...
        [Display(Name = "UDF1", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF1 { get; set; }

        [Display(Name = "UDF2", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF2 { get; set; }

        [Display(Name = "UDF3", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF3 { get; set; }

        [Display(Name = "UDF4", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF4 { get; set; }

        [Display(Name = "UDF5", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF5 { get; set; }

        [Display(Name = "UDF6", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF6 { get; set; }

        [Display(Name = "UDF7", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF7 { get; set; }

        [Display(Name = "UDF8", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF8 { get; set; }

        [Display(Name = "UDF9", ResourceType = typeof(ResGXPRConsignedJob))]
        public string UDF9 { get; set; }

        [Display(Name = "UDF10", ResourceType = typeof(ResGXPRConsignedJob))]
    ...
    public class ResGXPRConsignedJob
    {


        private static string resourceFile = "ResGXPRConsignedJob";


        /// <summary>
        ///   Looks up a localized string similar to GXPR Consigned Job.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to eTurns: GXPR Consigned Jobs.
        /// </summary>
