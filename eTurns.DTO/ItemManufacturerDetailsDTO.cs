...
{
    [Serializable]
    public class ItemManufacturerDetailsDTO
    {
        //ID
    ...
    public class ResItemManufacturerDetails
    {
        private static string ResourceFileName = "ResItemManufacturerDetails";
        ...
        /// <summary>
        ///   Looks up a localized string similar to ItemManufacturerDetails {0} already exist! Try with Another!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to ItemManufacturerDetails.
        /// </summary>
        public static string ItemManufacturerDetailsHeader
        {
            get
            {
                return ResourceRead.GetResourceValue("ItemManufacturerDetailsHeader", ResourceFileName);
            }
        }
        ...
        ///   Looks up a localized string similar to ItemManufacturerDetails.
        /// </summary>
        public static string ItemManufacturerDetails
        {
            get
            {
                return ResourceRead.GetResourceValue("ItemManufacturerDetails", ResourceFileName);
            }
        }
