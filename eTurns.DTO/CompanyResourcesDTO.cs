...
{
    [Serializable]
    public class CompanyResourcesDTO
    {
    ...
    [Serializable]
    public class CompanyResourcesKeyValDTO
    {
        public string ResourceKey { get; set; }
        public string ResourceValue { get; set; }
    }

    public class ResCompanyResources
    {
        private static string ResourceFileName = "ResCompanyResources";
