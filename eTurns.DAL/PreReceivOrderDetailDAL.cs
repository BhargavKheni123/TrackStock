...
{
    public class PreReceivOrderDetailDAL : eTurnsBaseDAL
    {
        #region [Class Constructor]

        //public PreReceivOrderDetailDAL(base.DataBaseName)
        //{

        //}

        public PreReceivOrderDetailDAL(string DbName)
        {
            base.DataBaseName = DbName;
        }

        //public PreReceivOrderDetailDAL(string DbName, string DBServerNm, string DBUserNm, string DBPswd)
        //{
        //    DataBaseName = DbName;
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<PreReceivOrderDetailDTO> GetAllRecordsByOrderDetailItem(Guid OrderDetailGuid, Guid ItemGuid)
        {
            using (var context = new eTurnsEntities(base.DataBaseEntityConnectionString))
            {
                var params1 = new SqlParameter[] { new SqlParameter("@OrderDetailGuid", OrderDetailGuid), 
                                                   new SqlParameter("@ItemGUID", ItemGuid) };

                IEnumerable<PreReceivOrderDetailDTO> obj = (from u in context.Database.SqlQuery<PreReceivOrderDetailDTO>("exec [GetPreReceivOrderDetail] @OrderDetailGuid,@ItemGUID", params1)
