...
namespace eTurns.DAL
{
    ...
    public partial class ItemMaster
    {
        ...
        public Nullable<double> PerItemCost { get; set; }
        ...
        public Nullable<long> OrderUOMID { get; set; }
        public bool IsAllowOrderCostuom { get; set; }
        public Nullable<double> SuggestedReturnQuantity { get; set; }
        public Nullable<double> WeightVariance { get; set; }
